...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["action"])) {
        if ($_POST["action"] == "add_player") {
            ...
            $sql_delete = "DELETE FROM each_team WHERE team_name='DC' AND id = $player_id";
            ...
            $sql_search = "SELECT * FROM each_team WHERE team_name='DC' AND player_name LIKE '%$search_name%'";
    ...
    // Display DC team player information
    $sql_select = "SELECT id, player_name, role, country, batting_style, bowling_style FROM each_team WHERE team_name='DC'";
    ...
    if ($result_select->num_rows > 0) {
        ...
        echo "<p>No players found for DC.</p>";
    }
