...
<head>
    ...
    <title>RR Team Information</title>
    <style>
...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["action"])) {
        if ($_POST["action"] == "add_player") {
            ...
            $sql_delete = "DELETE FROM each_team WHERE team_name='RR' AND id = $player_id";
            ...
            $sql_search = "SELECT * FROM each_team WHERE team_name='RR' AND player_name LIKE '%$search_name%'";
    ...
    // Display RR team player information
    $sql_select = "SELECT id, player_name, role, country, batting_style, bowling_style FROM each_team WHERE team_name='RR'";
    $result_select = $conn->query($sql_select);

    if ($result_select->num_rows > 0) {
        echo "<h2>RR Team Information</h2>";
        echo "<table>";
        echo "<tr>
               <th>ID</th>
                <th>Player Name</th>
        ...
        echo "<p>No players found for RR.</p>";
    }
